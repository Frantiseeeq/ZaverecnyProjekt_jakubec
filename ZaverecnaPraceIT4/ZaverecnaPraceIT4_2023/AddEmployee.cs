    ...
    public partial class AddEmployee : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
                ...
                {
                    con.Open();
                    cmd = new SqlCommand("insert into Employee (Employee_FirstName, Employee_LastName, Employee_Email, Employee_PhoneNumber) values ('" + txtName.Text + "','" + txtLastName.Text + "','" + txtEmail.Text + "','" + TxtPhone.Text + "')", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                cmd = new SqlCommand("update employee set Employee_FirstName = '" + txtName.Text + "', Employee_LastName = '" + txtLastName.Text + "', Employee_Email = '" + txtEmail.Text + "', Employee_PhoneNumber = '" + TxtPhone.Text + "' where Employee_Id = '"+ ID +"' ", con);
                cmd.ExecuteNonQuery();
                con.Close();
